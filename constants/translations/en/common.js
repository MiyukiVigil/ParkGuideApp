...
export default {
    ...
    phoneOnlyTitle: "Available on phone only",
    phoneOnlySubtitle: "Use the mobile app to open this feature.",
    phoneOnlyBody: "{{feature}} uses native phone features and is not available on the web version.",
    alertsDashboard: "Alerts Dashboard",
    videoEvidenceAlerts: "Video evidence alerts",
    viewLabel: "View",
    totalAlerts: "Total Alerts",
    pendingReview: "Pending Review",
    highSeverity: "High Severity",
    loadingAlerts: "Loading alerts...",
    noAlertsReceived: "No alerts received",
    noAlertsReceivedBody: "Camera-module alerts and uploaded evidence clips will appear here.",
    ...
    materialsLoadError: "Unable to load materials right now.",
    fileNameFallback: "File {{id}}",
    category: "Category",
    search: "Search",
    savedLocally: "Saved locally",
    confirmDelete: "Delete file?",
    confirmDeleteFile: "Remove this locally saved file from this device?",
    deleteAction: "Delete",
    successTitle: "Success",
    errorTitle: "Error",
    fileDeleted: "File deleted.",
    deleteError: "Unable to delete this file.",
    noDownloadUrlAvailable: "No download URL is available.",
    failedToLoadNotifications: "Failed to load notifications.",
    failedToMarkAllRead: "Failed to mark all notifications as read.",
    failedToClearNotifications: "Failed to clear read notifications.",
    activeGuideCount_one: "{{count}} active guide on the map",
    activeGuideCount: "{{count}} active guides on the map",
    activeGuideCount_other: "{{count}} active guides on the map",
    noGuideLocationsAvailable: "No guide locations are available right now.",
    lastUpdatedAt: "Last updated at {{time}}",
    guideLocationsUnavailable: "Guide locations are not available yet.",
    locationPermissionRequired: "Location permission is needed to share your live position.",
    locationShareFailed: "Your location could not be shared right now.",
    mapPhoneOnlyTitle: "Embedded map preview is available on Android or iOS.",
    mapPhoneOnlyBody: "Run the app on a phone or emulator to view guide locations without opening Google Maps.",
    you: "You",
    lastSeen: "Last seen {{time}}",
    liveLocation: "Live location",
    loadingGuides: "Loading guides",
    guidesVisible_one: "{{count}} guide visible",
    guidesVisible: "{{count}} guides visible",
    guidesVisible_other: "{{count}} guides visible",
    updatedAt: "Updated {{time}}",
    noLiveGuideCoordinates: "No live guide coordinates found.",
    back: "Back",
    enabled: "Enabled",
    disabled: "Disabled",
    system: "System",
    ...
    securitySetupPasskeyTitle: "Set up passkey sign-in",
    securitySetupPasskeyHint: "Use your device lock or biometric sign-in for faster access.",
    securitySetupPasswordHint: "Create a password before continuing.",
    securitySetupConfirmPassword: "Confirm password",
    securitySetupAuthenticatorStepReady: "Ready",
    securitySetupAuthenticatorStepScan: "Scan",
    securitySetupAuthenticatorStepConfirm: "Confirm",
    securitySetupAuthenticatorSecretHelp: "Keep this setup key somewhere safe.",
    securitySetupEnterCodeAfterScan: "Enter the code after scanning.",
    securitySetupGenerateAuthenticatorSecret: "Generate authenticator setup",
    securitySetupContinueToApp: "Continue to app",
    monitorLoadError: "Unable to load live monitor data from the backend.",
    recordedFootageDeleted: "Recorded footage deleted.",
