...
export default function Settings() {
  ...
  const handleLogout = async () => {
    await AsyncStorage.multiRemove(["accessToken", "refreshToken", "user", "role"]);
    router.replace("/");
  };
        ...
        >
          <TouchableRipple onPress={() => router.push("/account")} borderRadius={cardRadius}>
            <View
              style={[
                styles.profileInner,
                { paddingVertical: isSimpleMode || highContrast ? 22 : 18 },
              ]}
            >
              <Avatar.Icon
                icon="account"
              ...
              <View style={{ marginLeft: 14, flex: 1 }}>
                ...
                <Text
                  variant={isSimpleMode || highContrast ? "bodyMedium" : "bodySmall"}
        ...
        >
          ...
          <List.Item
            ...
            titleStyle={{
              ...
              fontWeight: "700",
              fontSize: isSimpleMode || highContrast ? 19 : 16,
            }}
            descriptionStyle={{
              color: theme.colors.onSurfaceVariant,
              fontSize: isSimpleMode || highContrast ? 15 : 13,
            }}
